...
#define LOW_PRECISION`),t}function b3(s){let t="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===t1?t="SHADOWMAP_TYPE_PCF":s.shadowMapType===YM?t="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===oa&&(t="SHADOWMAP_TYPE_VSM"),t}function T3(s){let t="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Bs:case Is:t="ENVMAP_TYPE_CUBE";break;case fu:t="ENVMAP_TYPE_CUBE_UV";break}return t}function A3(s){let t="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Is:t="ENVMAP_MODE_REFRACTION";break}return t}function R3(s){let t="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case dp:t="ENVMAP_BLENDING_MULTIPLY";break;case hE:t="ENVMAP_BLENDING_MIX";break;case dE:t="ENVMAP_BLENDING_ADD";break}return t}function C3(s){const t=s.envMapCubeUVHeight;if(t===null)return null;const i=Math.log2(t)-2,r=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,i),112)),texelHeight:r,maxMip:i}}function w3(s,t,i,r){const l=s.getContext(),c=i.defines;let f=i.vertexShader,d=i.fragmentShader;const m=b3(i),p=T3(i),v=A3(i),g=R3(i),x=C3(i),M=g3(i),E=v3(c),T=l.createProgram();let S,_,L=i.glslVersion?"#version "+i.glslVersion+`
...
`)+`
`+_);const U=L+S+f,D=L+_+d,H=S_(l,l.VERTEX_SHADER,U),F=S_(l,l.FRAGMENT_SHADER,D);l.attachShader(T,H),l.attachShader(T,F),i.index0AttributeName!==void 0?l.bindAttribLocation(T,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(T,0,"position"),l.linkProgram(T);function B(G){if(s.debug.checkShaderErrors){const at=l.getProgramInfoLog(T)||"",ut=l.getShaderInfoLog(H)||"",yt=l.getShaderInfoLog(F)||"",K=at.trim(),P=ut.trim(),W=yt.trim();let k=!0,_t=!0;if(l.getProgramParameter(T,l.LINK_STATUS)===!1)if(k=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(l,T,H,F);else{const Mt=E_(l,H,"vertex"),N=E_(l,F,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(T,l.VALIDATE_STATUS)+`
